...
private fun Route.implementGET() {
    // get all articales
    // http://localhost:port/articales
    get {
        call.respond(FreeMarkerContent("index.ftl", mapOf("articles" to ArticalManager.all())))
    }
...
private fun Route.implementPOST() {
    //save an artical
    post {
...
private fun Route.implementDELETE() {
